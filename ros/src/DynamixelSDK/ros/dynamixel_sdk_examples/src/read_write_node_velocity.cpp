...
#define ADDR_PRESENT_POSITION 128
...
int main(int argc, char ** argv)
{
  ...
  if (dxl_comm_result != COMM_SUCCESS) {
    ...
    ROS_INFO("Operating mode writeTxRx for Dynamixel ID %d: %d", DXL4_ID, op_mode_result);
  }
  
  // Initialize node, service, subscribers and publishers
  
  ros::init(argc, argv, "read_write_node_velocity");
  ros::NodeHandle nh;
